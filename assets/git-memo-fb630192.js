import{o,g as s,aM as r,d as l,aN as i,aO as m,l as p,j as a,E as g}from"./index-416b9b12.js";const d={class:"markdown-body"},h=r(`<h2>Configuration</h2><p>Set the global config</p><pre><code class="language-shell">git config --global user.name &quot;[name]&quot;
...
</code></pre>`,27),_=[h],u={__name:"git-memo.content",setup(c,{expose:e}){return e({frontmatter:{}}),(n,b)=>(o(),s("div",d,_))}},f=l({__name:"git-memo",setup(c){i(t=>({"8cb22b3c":a(e).cardColor}));const e=m();return(t,n)=>(o(),s("div",null,[p(a(u))]))}});const x=g(f,[["__scopeId","data-v-c7dbeca3"]]);export{x as default};
