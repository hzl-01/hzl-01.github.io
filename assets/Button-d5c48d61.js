import{Q as E,d as ee,bA as Se,a7 as Be,p as B,P as Te,K as Pe,L as p,S as b,bg as ke,br as oe,b1 as Re,a4 as g,R as l,a5 as X,bb as He,U as re,a0 as Ie,W as Ee,e as R,T as _e,bm as Fe,aJ as Oe,Y as r,ba as H,Z as De,ad as J,bt as je,bc as Ne,bd as Ke,ae as Me,aA as Ge}from"./index-a0e4cff7.js";import{i as _}from"./is-browser-fc34c9a6.js";import{u as We}from"./use-form-item-da8f8500.js";import{c as Z}from"./color-to-class-b0332f36.js";const Ve=E("base-wave",`
 position: absolute;
 left: 0;
 right: 0;
 top: 0;
...
`),Qe=ee({name:"BaseWave",props:{clsPrefix:{type:String,required:!0}},setup(e){Se("-base-wave",Ve,Be(e,"clsPrefix"));const f=B(null),h=B(!1);let u=null;return Te(()=>{u!==null&&window.clearTimeout(u)}),{active:h,selfRef:f,play(){u!==null&&(window.clearTimeout(u),h.value=!1,u=null),Pe(()=>{var v;(v=f.value)===null||v===void 0||v.offsetHeight,h.value=!0,u=window.setTimeout(()=>{h.value=!1,u=null},1e3)})}}},render(){const{clsPrefix:e}=this;return p("div",{ref:"selfRef","aria-hidden":!0,class:[`${e}-base-wave`,this.active&&`${e}-base-wave--active`]})}}),{cubicBezierEaseInOut:C}=ke;function qe({duration:e=".2s",delay:f=".1s"}={}){return[b("&.fade-in-width-expand-transition-leave-from, &.fade-in-width-expand-transition-enter-to",{opacity:1}),b("&.fade-in-width-expand-transition-leave-to, &.fade-in-width-expand-transition-enter-from",`
 ...
 margin-left ${e} ${C},
 margin-right ${e} ${C};
 `)]}const Ae=_&&"chrome"in window;_&&navigator.userAgent.includes("Firefox");const Le=_&&navigator.userAgent.includes("Safari")&&!Ae;function $(e){return oe(e,[255,255,255,.16])}function I(e){return oe(e,[0,0,0,.12])}const Ye=Re("n-button-group"),Ue=b([E("button",`
 margin: 0;
